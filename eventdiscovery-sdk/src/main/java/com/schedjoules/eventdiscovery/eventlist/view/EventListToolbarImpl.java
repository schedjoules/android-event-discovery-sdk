 ...
 */
public final class EventListToolbarImpl implements EventListToolbar
{
    private final Toolbar mToolbar;


    public EventListToolbarImpl(Toolbar toolbar, final Listener listener, FragmentActivity fragmentActivity)
    {
        mToolbar = toolbar;
