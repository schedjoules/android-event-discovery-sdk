...
/**
 * An {@link Optional} {@link Token} that represents the country code of the current SIM card. This is merely a best guess and not always accurate, though for
 * most mobile devices it should work.
 *
 * @author Marten Gajda
 */
public final class SimCountryCode implements Optional<Token>
{
    ...
    /**
     * Creates a new {@link SimCountryCode}.
     *
     * @param context
     *         A {@link Context}.
     */
    public SimCountryCode(Context context)
    {
    ...
    private Token countryCodeToken()
    {
        if (mCachedValue == null)
        {
            ...
            String country = tm.getPhoneType() == TelephonyManager.PHONE_TYPE_CDMA ? null : tm.getSimCountryIso();
